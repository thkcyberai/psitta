...
class QuillNativeBridgeWindows extends QuillNativeBridgePlatform {
  ...
  Future<void> copyHtmlToClipboard(String html) async {
    ...
    try {
      ...
      final clipboardMemoryHandle = GlobalAlloc(GLOBAL_ALLOC_FLAGS.GMEM_MOVEABLE, htmlSize);
  ...
  Future<void> openGalleryApp() async {
    ...
    ShellExecute(NULL, openPtr, uriPtr, nullptr, nullptr, SHOW_WINDOW_CMD.SW_SHOWNORMAL);
